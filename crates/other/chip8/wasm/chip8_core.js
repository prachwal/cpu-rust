...
export class Emulator {
    ...
    get_display() {
        try {
            ...
            wasm.emulator_get_display(retptr, this.__wbg_ptr);
     ...
     */
    get_sound() {
        const ret = wasm.emulator_get_sound(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {number} key
     */
    key_down(key) {
        wasm.emulator_key_down(this.__wbg_ptr, key);
    }
    /**
     * @param {number} key
     */
    key_up(key) {
        wasm.emulator_key_up(this.__wbg_ptr, key);
    }
    /**
    ...
    tick_timers() {
        wasm.emulator_tick_timers(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chip8_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
